...
(function () {
    ...
    authService.$inject = ['$rootScope', '$http', '$q', 'appConfig', 'localStorageService', 'ds.session'];

    function authService($rootScope, $http, $q, appConfig, localStorageService, dsSession) {
        ...
        var _login = function (user) {
            ...
            $http.post(serviceBase + '/token', data, { headers: { 'Content-Type': 'application/x-www-form-urlencoded' } }).success(function (response) {
                ...
                _authentication.IdUser = response.id_user;
